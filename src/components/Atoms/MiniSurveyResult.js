...
function MiniSurveyResult() {
  return (
    ...
    <div>
      ...
      <div className="w-full mr-20">
        <div className="misc-box bg-primary flex justify-between items-center w-96 p-xs mb-xs rounded-md">
          <div className="flex items-center">
            <svg
              className="mr-s"
              width="24"
          ...
          <h3 className="text-base font-medium text-white">🌟 60%</h3>
        </div>
      </div>
      ...
      <div className="w-full mr-20">
        <div className=" bg-primary flex justify-between items-center w-33xl p-xs mb-xs rounded-md">
          <div className="flex items-center">
            <svg
              className="mr-s"
              width="24"
...
export default MiniSurveyResult;
