...
function GroupOfFourOptionResult() {
  return (
    <div>
      ...
      <div className=" bg-primary-shd7 flex justify-between items-center w-36 p-xs mb-xs rounded-md">
        <div className="flex items-center">
          <svg
            className="mr-s"
            width="24"
        ...
        <h3 className="text-base font-medium text-dark">10%</h3>
      </div>
      ...
      <div className="w-full mr-20">
        <div className="misc-box bg-primary flex justify-between items-center w-33xl p-xs mb-xs rounded-md">
          ...
          <h3 className="text-base font-medium text-white">🌟 70%</h3>
        </div>
      </div>
      <div className=" bg-primary-shd7 flex justify-between items-center  w-28 p-xs mb-xs rounded-md">
        <div className="flex items-center">
          <svg
            className="mr-s"
            width="24"
        ...
        <h3 className="text-base font-medium text-dark">5%</h3>
      </div>
    </div>
  );
}

export default GroupOfFourOptionResult;
